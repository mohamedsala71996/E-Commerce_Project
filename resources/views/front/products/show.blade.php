                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <ul class="breadcrumb-nav">
                            <li><a href="{{route('frontproducts.index') }}"><i></i>shop</a></li>
                            <li><a href="index.html"><i></i>{{ $product->name }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{currencyFormat::Format($product->price)}} @if($product->compare_price)<span>{{currencyFormat::Format($product->compare_price)}}</span>@endif </h3>
