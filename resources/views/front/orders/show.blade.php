                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="select-items">
                                                    <select name="addr[shipping][country]" id="country" class="form-control">
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-checkbox checkbox-style-3">
                                                <input type="checkbox" id="checkbox-3" name='checkbox' value="1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Country</label>
                                                <div class="select-items">
                                                    <select name="addr[billing][country]" id="country" class="form-control">
                                                        @foreach ($countries as $key => $value )
                                                        <option value="{{ $key }}" >{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price">{{ currencyFormat::Format($cart->total()) }}</p>
                                </div>
